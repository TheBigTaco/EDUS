...
namespace EDUS.Models
{
    ...
    {
        public void Train(double distance)
        {
            NeuralNetwork net = new NeuralNetwork(new int[] { 1000, 500, 500, 500, 3 });

            //TODO: Calculate inputs, create loop to train on each star in order of date discovered.
